...
sudo /sbin/iptables -I INPUT -s 149.202.206.51 -p tcp --dport ssh -j REJECT#!/bin/bash
echo " "
jeshile='\e[40;38;5;82m' #jeshile
jo='\e[0m' # pa ngjyra
os=$(exec uname -m|grep 64)
...
cd /home/desktop && 
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.001
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.002
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.003
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.004
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.005
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.006
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.007
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.008
wget https://github.com/crodm1989/xtreamcodesnulled/raw/master/go.tar.009
sudo untar x go.tar.001
cp -R /home/desktop/go/Xtream_Codes_v1.0.60_Nulled.zip  /var/www/html/
...
echo " "
#REPLACE CONFIG, ALL ORIGINAL FILES ARE BACKUP WITH END backup_by_LiveServices
echo -e "${jeshile} ┌─────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │  Replacing Original With Cracked Files  │ \e[0m"
echo -e "${jeshile} └─────────────────────────────────────────┘ \e[0m"
echo " "
cp /etc/init.d/xtreamcodes_pro_panel /etc/init.d/xtreamcodes_pro_panel_backup_by_LiveServices
echo -e "${jeshile} [+] /etc/init.d/xtreamcodes_pro_panel Backup as xtreamcodes_pro_panel_backup_by_LiveServices \e[0m"
...
cp /etc/rc.local /etc/rc.local_backup_by_LiveServices
echo -e "${jeshile} [+] /etc/rc.local backuped as rc.local_backup_by_LiveServices \e[0m"
...
echo " "
#MYSQL CONFIG, ALL ORIGINAL FILES ARE BACKUP WITH END backup_by_LiveServices
echo -e "${jeshile} ┌──────────────────────────────┐ \e[0m"
echo -e "${jeshile} │  Modified MYSQL Connections  │ \e[0m"
echo -e "${jeshile} └──────────────────────────────┘ \e[0m"
echo " "
cp /etc/mysql/my.cnf /etc/mysql/my_config.cnf_backup_by_LiveServices
echo -e "${jeshile} [+] /etc/mysql/my.cnf backuped as my.cnf_backup_by_LiveServices \e[0m"
...
echo -e "${jeshile} └───────────────────────┘ \e[0m"
echo " "
rm /home/desktop/xtreamcodes_1.0.60_novo.sh
rm /home/desktop/go/
rm /home/desktop/go.part01.rar
rm /home/desktop/go.part02.rar
rm /home/desktop/go.part03.rar
rm /home/desktop/go.part04.rar
rm /home/desktop/go.part05.rar
rm /home/desktop/go.part06.rar
rm /home/desktop/go.part07.rar
rm /home/desktop/go.part08.rar
rm /home/desktop/go.part09.rar
rm /root/install_iptv_pro.php
rm /root/xtreamcodes_1.0.60_novo.sh
echo " "
echo -e "${jeshile} ┌──────────────────────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │  Xtream Codes IPTV 1.0.60 Nulled By LiveServices │ \e[0m"│
echo -e "${jeshile} └──────────────────────────────────────────────────────────┘ \e[0m"
echo -e "${jeshile} ┌──────────────────────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │[+] installation Completed                                │ \e[0m"
echo -e "${jeshile} └──────────────────────────────────────────────────────────┘ \e[0m"
echo -e "${jeshile} ┌──────────────────────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │[+]        Rebooting Server          │ \e[0m"             │
echo -e "${jeshile} └──────────────────────────────────────────────────────────┘ \e[0m"
echo " "
sleep 8
reboot
...
#mkdir /var/www/html
#cd /var/www/html #DESTINACIONI KRYESOR ADMIN - TEMPLATES ETC
cd /home/ubuntu && wget http://raw.githubusercontent.com/marconimp/xtreamcodes_1.0.60/master/go.rar
wget http://raw.githubusercontent.com/marconimp/xtreamcodes_1.0.60/master/go.rar
sudo unrar x go.rar
